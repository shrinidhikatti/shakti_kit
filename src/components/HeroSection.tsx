...
const heroImage = 'https://pngjunction.com/wp-content/uploads/2025/07/20-1-300x300.png';
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        <div className="animate-float">
          <div className="relative inline-block">
            {/* Responsive image container - height 60% of viewport */}
            <div className="mx-auto mb-0 relative h-[60vh] w-auto">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
          The <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-yellow-300">Sacred</span>
          <br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-orange-400">Shakti Kit</span>
        </h1>
        ...
        <div className="flex items-center justify-center space-x-2 text-yellow-300 mb-8">
          {[...Array(5)].map((_, i) => (
